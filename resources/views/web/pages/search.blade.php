		...
		<div class="row">
			...
			<div class="col-lg-8 col-12 mb-50">
				...
				<div class="single-blog mb-50">
					<div class="blog-wrap">
						<!-- Title -->
						<h3 class="title">Hasil pencarian "{{$query}}":</h3>
						<div class="content">
							...
							<div class="row">
                                    ...
                                    <div class="col-md-6 col-12 mb-20">
                                        ...
                                        <div class="post feature-post post-separator-border">
                                            <div class="post-wrap">
                                                <!-- Image -->
                                                <a class="image" href="{{ $a[0]->slug_kategori.'/'.$a[0]->slug }}"><img src="{{ asset('images/' . $a[0]->penulis . '/article-images/thumbnail/371'.$a[0]->thumbnail) }}" alt="post"></a>
                                                <!-- Content -->
                                                <div class="content">
                                                    <!-- Title -->
                                                    <h4 class="title"><a href="{{ $a[0]->slug_kategori.'/'.$a[0]->slug }}">{{ ucfirst($a[0]->judul) }}</a></h4>
                                                    <!-- Meta -->
                                                    <div class="meta fix">
                                                        <a href="#" class="meta-item author"><i class="fa fa-user"></i>{{ucfirst($a[0]->nama_penulis)}}</a>
                                                        <span class="meta-item date"><i class="fa fa-clock-o"></i>{{ date("d/m/Y", strtotime($a[0]->created_at)) }}</span>
                                                        <a href="#" class="meta-item comment"><i class="fa fa-comments"></i>({{ $a[0]->accessed }})</a>
                                                    </div>
                                                    <!-- Description -->
                                                    
                                                    <p style="font-size: 13px">@php
                                                        echo (strlen($a[0]->deskripsi) > 120) ? substr($a[0]->deskripsi, 0, 120) . '...' : $a[0]->deskripsi;
                                                    @endphp</p>
                                                </div>
